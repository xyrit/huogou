CREATE TABLE `jdcard_buyback_list` (
   ...
   `face_value` int(10) NOT NULL DEFAULT '0' COMMENT '面额',
   `period_id` int(10) NOT NULL DEFAULT '0' COMMENT '期数id',
   `order_type` int(1) NOT NULL DEFAULT '0' COMMENT '订单类型 0 普通',
   `rate` int(3) NOT NULL DEFAULT '0' COMMENT '折扣',
   PRIMARY KEY (`id`)

(function (a) {
    a.picslider = function (e, c) {
        var f = a(e), g = a.extend({}, a.picslider.defaults, c), h = ("ontouchstart" in window) || window.DocumentTouch && document instanceof DocumentTouch, d = (h) ? "touchend" : "click", b = {};
        ...
        b = {
            init: function () {
                ...
                f.transitions = (function () {
                    var l = document.createElement("div"), k = ["perspectiveProperty", "WebkitPerspective", "MozPerspective", "OPerspective", "msPerspective"];
                    for (var j in k) {
                ...
                setup: function () {
                    ...
                    f.directionNav.bind(d, function (j) {
                        j.preventDefault();
                ...
                function s(w) {
                    ...
                    if (f.animatingTo === f.currentSlide && !o && !(t === null)) {
                        var v = t, u = (v > 0) ? f.getTarget("next") : f.getTarget("prev");
                        if (f.canAdvance(u)) {
        ...
        f.flexAnimate = function (o, r, j) {
            if (!f.animating && (f.canAdvance(o) || j) && f.is(":visible")) {
                ...
                var m = f.computedW, l, k, i, n = true, q;
        ...
        f.setup = function () {
            ...
            f.newSlides.css({width: f.computedW, "float": "left", display: "block"});
        ...
        return this.each(function () {
            ...
            if (c.length === 0) {
                ...
                if (c.length === 1) {
                    ...
                    c.parent().fadeIn(400)
                     ////修复一张图图片布局中的问题
//                     var pbox =   d.find(".slides");
//                             pbox.css("margin-left",pbox.parent().width()/2);
//                             d.find(".direction-nav").hide();
                        var k = d.parent().find("dd");
                        if (k.length == 1) {
                            $("div.flex-viewport").find("ul.slides").removeAttr("style").show().find("li").removeAttr("style");

$(function(){
        $("#dlList").after(
                        ...
                        +'<div class="noRecords colorbbb clearfix" style="display:none;" id="nohave"><s></s>最近三个月无记录 <div class="z-use">请使用电脑访问www.huogou.com查看更多</div> </div>'
                        +'<div style="display: none;" id="btnLoadMore" class="load_more"><a title="加载更多" href="javascript:void(0);" >点击加载更多</a><b></b> </div>'
                        //+'<div class="g-suggest clearfix"  id="">请使用电脑访问www.huogou.com查看更多</div>'
         );

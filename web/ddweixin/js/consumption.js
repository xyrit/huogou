...
$(function() {
    ...
    $.getJsonp(url,data,function(json) {
        ...
        $('#btnRecharge').html('<b>充值明细</b>总金额：'+totalRechargeMoney+' 夺宝币');
    });
    ...
    $.getJsonp(url,data,function(json) {
        ...
        $('#btnConsumption').html('<b>消费明细</b>总金额：'+totalPayMony+' 夺宝币');
    });
});
...
function createPayrecordListHtml(json) {
    ...
    $.each(json.list, function(i,v) {
        ...
        html += '<li class=""><span>'+payTime+'</span><span>'+payPrice+' 夺宝币</span></li>';
    });
...
function createRechargeListHtml(json) {
    ...
    $.each(json.list, function(i,v) {
        ...
        html += '<li class=""><span>'+payTime+'</span><span>'+payPrice+' 夺宝币</span><span>'+payMent+'</span></li>';
    });

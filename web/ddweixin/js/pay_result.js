...
function showshare(type)
{
    if(type=="button")
    {
        $('.share-wrapper').css({'bottom':'-250px'});
        $('.share-btn-wrap').show();
    }
    else if(type=="pic")
    {
        $('.share-wrapper').css({'bottom':'0px'});
        $('.share-btn-wrap').hide();
    }
    else return ;
...
//            console.log(e);
//            alert($(e.target).parents('.footer').length);
        if($(e.target).parents('.footer').length == 0){
            $('.share-wrapper').animate({'bottom':'-250px'});
            $('.share-btn-wrap').show();
        }else if($(e.target).parents('.footer').length == 1){
            $('.share-wrapper').animate({'bottom':'0'});
            $('.share-btn-wrap').hide();
        }
    });
})

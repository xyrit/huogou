...
$(function() {
    ...
    $.getJsonp(apiBaseUrl+'/period/info', {id:periodId}, function(json) {
        ...
        if (periodLeftTime>0) {
            ...
            var calresultUrl = wwwBaseUrl+'/didi_app/compute.html?showBar=1&pid='+periodId;
            ...
            $('.ann_btn:eq(1) a:eq(3)').attr('href', weixinBaseUrl+'/moreperiod-'+productId+'.html');
            ...
            var calresultUrl = wwwBaseUrl+'/didi_app/compute.html?pid='+periodId;
...
function createLotteryDetailInfo(json) {
   ...
   // var periodNumber = periodInfo.period_number;
    ...
    html += '</ul>';
    html += '<dl>';
    html += '<dt class="gray6">幸运夺宝码：<b class="orange">'+luckyCode+'</b></dt>';
    html += '<dd class="gray9">揭晓时间：'+raffTime+'</dd> <dd class="gray9"> 夺宝时间：'+userBuyTime+' </dd> ';
    html += '</dl>';

    ...
    tabs.click(function () {                              //标签的单击事件
        ...
        $.getJsonp(apiBaseUrl + '/recharge/money-log', {
            ...
            $(json.list).each(function (i, p) {
                switch (index) {
                    case 1:
                        strHtml += "<dd>          <span>" + p.pay_time.substr(0, 19) + "</span>             <span>" + p.post_money + " 夺宝币</span>  <span>" + p.payment + "</span>      </dd>";  //payment
                        break;
                    case 0:
                        strHtml += "<dd>          <span>" + p.pay_time.substr(0, 19) + "</span>             <span>" + p.money * -1 + " 夺宝币</span>         </dd>";
                        break;
                    case 2:
                        strHtml += "<dd>          <span>" + p.pay_time + "</span>              <span>" + p.money + " 夺宝币</span>   <span>" + p.to_account + "[" + p.payment + "]</span>      </dd>";
                        break;
                }
            });
            ...
            if (index == 2) totel.html("转入总额：" + json.totalInMoney + " 夺宝币<cite>转出总额：" + json.totalOutMoney + " 夺宝币</cite>");
            //显示加载更多和 没有数据

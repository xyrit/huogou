...
(function () {
    ...
    Gobal.NoneHtmlEx = function (b) {
        return '<div class="noRecords colorbbb clearfix"><s></s>' + b + '<div class="z-use">请下载“伙购网”APP查看更多</div></div>'
    };
    Gobal.LookForPC = '<div class="g-suggest clearfix">请下载“伙购网”APP查看更多</div>';

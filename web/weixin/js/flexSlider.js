...
(function (a) {
    a.flexslider = function (d, j) {
        var b = a(d), i = a.extend({}, a.flexslider.defaults, j), f = i.namespace, h = ("ontouchstart" in window) || window.DocumentTouch && document instanceof DocumentTouch, c = (h) ? "touchend" : "click", g = i.direction === "vertical", e = {};
        ...
        e = {
            init: function () {
                ...
                b.transitions = (function () {
                    var m = document.createElement("div"), l = ["perspectiveProperty", "WebkitPerspective", "MozPerspective", "OPerspective", "msPerspective"];
                    for (var k in l) {
                ...
                if (i.slideshow) {
                    (i.initDelay > 0) ? setTimeout(b.play, i.initDelay) : b.play()
                }
                if (h && i.touch) {
                    e.touch()
                }
                ...
                setup: function () {
                    ...
                    var m = (i.controlNav === "thumbnails") ? "control-thumbs" : "control-paging", k = 1, n;
                    ...
                    e.controlNav.active();
                    if (i.controlType == 1) {
                        b.controlNav.bind(c, function (r) {
                            alert("sss");
                            r.preventDefault();
                            var t = a(this), s = b.controlNav.index(t);
                        ...
                        if (h) {
                            b.controlNav.bind("click touchstart", function (r) {
                                r.preventDefault()
                            })
                        }
                    }
                    ...
                    e.controlNav.set();
                    (b.pagingCount > 1 && b.pagingCount !== b.controlNav.length) ? b.update(l, k) : e.controlNav.active()
                }
            }, directionNav: {
                setup: function () {
                ...
                function u(y) {
                    if (b.animatingTo === b.currentSlide && !q && !(v === null)) {
                        var x = v, w = (x > 0) ? b.getTarget("next") : b.getTarget("prev");
                        if (b.canAdvance(w)) {
        ...
        b.flexAnimate = function (p, o, l) {
            if (!b.animating && (b.canAdvance(p) || l) && b.is(":visible")) {
                ...
                var n = (g) ? b.slides.filter(":first").height() : b.computedW, m, q, k;

 ...
 */
function sign(&$params, $sign_cert_path, $sign_cert_pwd) {
	global $log;
	$log->LogInfo ( '=====签名报文开始======' );
	...
	$private_key = getPrivateKey ( $cert_path,$sign_cert_pwd );
	// 签名
 ...
 * @return unknown
 */
function getCertId($cert_path, $sign_cert_pwd) {
 ...
 * @return unknown
 */
function getPrivateKey($cert_path, $sign_cert_pwd) {
 ...
 * @return unknown
 */
function decryptData($data, $cert_path,$sign_cert_pwd) {
